...
# test_50_2000_500_1_1_2_3_0_0_2_1  experiment15  7
def main():
    #filepath= "./tests/test_50_2000_500_1_2_2_4_0_0/"
    filepath = "/Users/mayahilwani/PycharmProjects/msc-mhilwani/tests/test_50_2000_500_0_2_2_3_0_0_0_2/" #/msc-mhilwani # test_1_2250_250_0_1_2_2_0_0_0_1
    slope = Slope()
    ...
    filename1 = filepath + str('experiment37')
    cc.loadData(filename1)
    cc.run(2, [5], False, False)
