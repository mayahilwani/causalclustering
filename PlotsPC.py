...
def plot_data(gt, data):
    ...
    for variable_index in ordering:
        ...
        for idx, parent_index in enumerate(pa_i):
            ...
            print('MARS RETURN: ' + str(sse) + '++' + str(coeffs)+ '++' + str(no_of_terms)+ '++' + str(interactions) + '++' + str(rearth))
            # Calculate residuals
...
def main():
    try:
        base_path = "C:/Users/ziadh/Documents/CausalGen-Osman/mintv_data/experimentM2"
