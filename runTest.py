...
def run_code(n, orig, intv, intv_type, f, clusters, k, r, mdl_th, intv_strength, noise_level):
    ...
    # Data gen filepath
    dg_filepath = f"/Users/mayahilwani/PycharmProjects/tests/three_k/{foldername}"

    # Filepath
    filepath = f"/Users/mayahilwani/PycharmProjects/tests/three_k/{foldername}" #f"C:/Users/ziadh/Documents/..MAYAMSC/results/tests/{foldername}"
...
def main():
   # 2500   2000-500  2250-250
    ...
    clusters = 3   # Number of clusters for data generation
    k = 4         # Number of clusters for method
    r = 0          # Random flag
    mdl_th = 0
    intv_strength = 0  # 0, 1 or 2
